document.addEventListener("DOMContentLoaded", function() {
    ...
    var opciones = [
      { text: "Menu", value: "" },
      { text: "ir a reproductor de audio", value: "./reproductorDeAudio.html" },
      { text: "ir a reproducro de video", value: "./reproductor de video.html" },
      { text: "ir a pagina web.", value: "./index.html" },
